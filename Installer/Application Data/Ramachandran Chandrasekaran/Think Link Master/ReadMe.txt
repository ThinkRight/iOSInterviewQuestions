...
Usage:
======
1. To add new concepts or definitions: Insert a new MenuItem (Ctrl + Shift + N) or Sub-MenuItem (Ctrl + N) as a concept and its definition as a Sub-MenuItem(Ctrl + N).. ..inside the prior created concept MenuItem.
